...
// Define a mapping of birds to their countries
const birdCountries = {
  "Common Pheasant": [
    "United Kingdom",
    "Ireland",
...
fs.readFile("db.json", "utf8", (err, data) => {
  ...
  try {
    ...
    // Function to add countries to each bird object
    const addCountries = (bird) => {
    ...
    // Update each bird object with countries
    const updatedBirds = birds.map(addCountries);

    // Convert back to JSON string
    const updatedJson = JSON.stringify(updatedBirds, null, 2);
